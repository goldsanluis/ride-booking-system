...
ACCENT       = "#FFD700"   # PUP Gold (primary accent)
ACCENT_DARK  = "#B8860B"   # Dark gold (hover)
ACCENT_LIGHT = "#FFD700"   # PUP Gold (lighter accent)
TEXT_WHITE   = "#FFFFFF"
TEXT_GRAY    = "#ffcccc"
BORDER       = "#990000"
GREEN        = "#90EE90"
...
class DriverDashboard:
    ...
    def setup_header(self):
        ...
        tk.Button(row, text="Logout 🚪",
                  font=(FONT_FAMILY, 10, "bold"), bg=ACCENT, fg=BG_DARK,
